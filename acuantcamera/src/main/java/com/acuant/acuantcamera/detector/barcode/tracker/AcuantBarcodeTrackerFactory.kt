 ...
 */
internal class BarcodeTrackerFactory(private val handler: AcuantBarcodeDetectorHandler) : MultiProcessor.Factory<Barcode> {

    override fun create(barcode: Barcode): Tracker<Barcode> {
        return AcuantBarcodeTracker(handler)
    }
