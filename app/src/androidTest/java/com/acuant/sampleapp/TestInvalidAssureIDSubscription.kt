...
class TestInvalidAssureIDSubscription {
    @get:Rule
    ...
    fun test() {
        try {
            ...
            subscriptionCredentials.subscription = "30A24E86-9XXX-423F-9939-533AF439CA4F"
            subscriptionCredentials.endpoint = "services.assureid.net"
