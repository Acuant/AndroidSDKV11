...
- Uses Camera 1 to capture facial liveliness using a proprietary algorithm.
...
This module checks for liveliness (whether the subject is a live person) by using blink detection. 
